...
install_accessories_apps(){
  ...
  do
    ...
    echo "12) $(menu_item "insync") $AUR"
    echo "13) $(menu_item "crossover") $AUR"
    echo ""
    echo " b) BACK"
    echo ""
...
install_development_apps(){
  ...
  do
    ...
    echo "28) $(menu_item "dbeaver" "Dbeaver") $AUR"    
    echo ""
    echo " b) BACK"
    echo ""
        ...
        1)
          ...
          do
            ...
            echo " 7) $(menu_item "tor browser") $AUR"
	          ...
	          echo " 9) $(menu_item "mullvad-vpn-bin" "Mullvad VPN") $AUR"
            echo ""
            echo " b) BACK"
            echo ""
            BROWSERS_OPTIONS+=" b"
            ...
            for OPT in "${OPTIONS[@]}"; do
              case "$OPT" in
                ...
                8)
                  ...
                  ;;
                9)
                  aur_package_install "mullvad-vpn-bin"
                  ;;
                "b")
                  break
                  ;;
